...
export interface IHelloPnPContorlsWebPartProps {
  description: string;
  people: IPropertyFieldGroupOrPerson[]; // 선택한 사람들이 담길 배열
...
export default class HelloPnPContorlsWebPart extends BaseClientSideWebPart<IHelloPnPContorlsWebPartProps> {
  ...
  public render(): void {
    ...
    if (this.properties.expansionOptions && this.properties.expansionOptions.length >= 1) {
