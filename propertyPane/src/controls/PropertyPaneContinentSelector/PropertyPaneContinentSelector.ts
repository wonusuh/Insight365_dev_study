  ...
  implements IPropertyPaneField<IPropertyPaneContinentSelectorInternalProps>
{
  ...
  constructor(
    ...
    properties: IPropertyPaneContinentSelectorProps
  ) {
    this.properties = {
  ...
  private onRender(element: HTMLElement): void {
    ...
    const reactElement: React.ReactElement<IContinentSelectorProps> =
      React.createElement(ContinentSelector, <IContinentSelectorProps>{
