...
import * as LoansPrograms from './module07_loan-programs.js';
...
let interestOnlyPayment = LoansPrograms.calculateInterestOnlyLoanPayment({ principle: 30000, interestRate: 5 });
let conventionalLoanPayment = LoansPrograms.calculateConventionalLoanPayment({ principle: 30000, interestRate: 5, months: 180 });
